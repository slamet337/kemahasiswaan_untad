          ...
          <form role="form" method="post" action="<?= base_url('mahasiswa/update/' . $mahasiswa->id); ?>">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <select name="fakultas_id" class="form-control select-fakultas" style="width: 100%;">
                  ...
                  <?php foreach ($fakultas as $f) { ?>
                    <option value="<?= $f->id ?>" <?= ($f->id == $mahasiswa->fakultas_id) ? 'selected="selected"' : ''; ?> >(<?= $f->kode_fakultas ?>) <?= $f->nama_fakultas ?></option>
                  <?php } ?>
                </select>
              </div>
              ...
              <div class="form-group">
                ...
                <input name="status" type="text" class="form-control" id="status" value="<?= $mahasiswa->status ?>" maxlength="7">
              </div>
